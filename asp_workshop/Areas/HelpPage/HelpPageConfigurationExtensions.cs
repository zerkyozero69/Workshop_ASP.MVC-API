...
using global::asp_workshop.Areas.HelpPage.Models;
...
namespace asp_workshop.Areas.HelpPage
{
    public static class HelpPageConfigurationExtensions
    {
        ...
        private static void GenerateUriParameters(HelpPageApiModel apiModel, ModelDescriptionGenerator modelGenerator)
        {
            ...
            foreach (ApiParameterDescription apiParameter in apiDescription.ParameterDescriptions)
            {
                if (apiParameter.Source == ApiParameterSource.FromUri)
                {
                    ...
                    if (parameterDescriptor is object)
                    {
                    ...
                    if (complexTypeDescription is object && !IsBindableWithTypeConverter(parameterType))
                    {
                        foreach (ParameterDescription uriParameter in complexTypeDescription.Properties)
                            apiModel.UriParameters.Add(uriParameter);
                    }
                    else if (parameterDescriptor is object)
                    {
                    ...
                    {
                        Debug.Assert(parameterDescriptor is null);
        ...
        private static bool IsBindableWithTypeConverter(Type type)
        {
            if (type is null)
            {
                return false;
        ...
        private static void GenerateRequestModelDescription(HelpPageApiModel apiModel, ModelDescriptionGenerator modelGenerator, HelpPageSampleGenerator sampleGenerator)
        {
            ...
            foreach (ApiParameterDescription apiParameter in apiDescription.ParameterDescriptions)
            {
                ...
                else if (apiParameter.ParameterDescriptor is object && apiParameter.ParameterDescriptor.ParameterType == typeof(HttpRequestMessage))
                {
        ...
        private static void GenerateResourceDescription(HelpPageApiModel apiModel, ModelDescriptionGenerator modelGenerator)
        {
            ...
            if (responseType is object && responseType != typeof(void))
            {
        ...
        private static bool TryGetResourceParameter(ApiDescription apiDescription, HttpConfiguration config, ref ApiParameterDescription parameterDescription, ref Type resourceType)
        {
            parameterDescription = apiDescription.ParameterDescriptions.FirstOrDefault(p => p.Source == ApiParameterSource.FromBody || p.ParameterDescriptor is object && p.ParameterDescriptor.ParameterType == typeof(HttpRequestMessage));
        ...
        private static ModelDescriptionGenerator InitializeModelDescriptionGenerator(HttpConfiguration config)
        {
            ...
            foreach (ApiDescription api in apis)
            {
                ...
                Type parameterType = null;
                if (TryGetResourceParameter(api, config, ref parameterDescription, ref parameterType))
                {
