...
namespace asp_workshop.Areas.HelpPage.ModelDescriptions
{
    ...
    public class ModelDescriptionGenerator
    {
        ...
        private Dictionary<string, ModelDescription> m_GeneratedModels;
        ...
        private static string GetMemberName(MemberInfo member, bool hasDataContractAttribute)
        {
            ...
            if (jsonProperty is object && !string.IsNullOrEmpty(jsonProperty.PropertyName))
            {
            ...
            if (hasDataContractAttribute)
            {
                ...
                if (dataMember is object && !string.IsNullOrEmpty(dataMember.Name))
                {
        ...
        private static bool ShouldDisplayMember(MemberInfo member, bool hasDataContractAttribute)
        {
            ...
            bool hasMemberAttribute = member.DeclaringType.IsEnum ? member.GetCustomAttribute<EnumMemberAttribute>() is object : member.GetCustomAttribute<DataMemberAttribute>() is object;
            ...
            return jsonIgnore is null && xmlIgnore is null && ignoreDataMember is null && nonSerialized is null && (apiExplorerSetting is null || !apiExplorerSetting.IgnoreApi) && (!hasDataContractAttribute || hasMemberAttribute);
        }
        ...
        private string CreateDefaultDocumentation(Type type)
        {
            ...
            if (DocumentationProvider is object)
            {
        ...
        private void GenerateAnnotations(MemberInfo property, ParameterDescription propertyModel)
        {
            ...
            {
                Func<object, string> textGenerator = null;
        ...
        private ModelDescription GenerateComplexTypeModelDescription(Type modelType)
        {
            ...
            bool hasDataContractAttribute = modelType.GetCustomAttribute<DataContractAttribute>() is object;
